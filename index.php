...
<head>
    ...
    <title>Michael Cabana - Web Developer / Freelancer</title>
    ...
    <nav id="mainNav" class="navbar navbar-default navbar-fixed-top navbar-custom">
        <div class="container">
            ...
            <div class="navbar-header page-scroll">
                ...
                <a class="navbar-brand" href="#page-top">Michael Cabana</a>
            </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="intro-text">
                        ...
                        <hr class="star-light">
                        <span class="skills">Software/Web Developer - Bachelor of Computer Science  - User Experience Designer<br> PHP - MySQL - Python - Java - MVC - CodeIgniter - C++ - Node.js</span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-4 col-lg-offset-2">
                    <p>Since I believe websites are where it's at, I figured what better way to showcase me. So here's a little about me and some of my works you can see above. Short, sweet, to the point. Just how I like it. </p>
                    <p>My name is Michael Cabana and I'm a Computer Science student at <a style="color:white" href="http://concordia.ca" target="_blank">Concordia University</a>.</p>
                </div>
                <div class="col-lg-4">
                    <p>I'm studying in the Web Services and Applications option of the program but have digested many programming languages during my studies. I've recently grown an affinity for C++. I'm set to graduate Summer of 2017 and the date can't come fast enough. </p>
                </div>
                <div class="col-lg-8 col-lg-offset-2 text-center">
                    <a href="/resume2017.pdf" class="btn btn-lg btn-outline">
    ...
    <footer class="text-center">
                ...
                <div class="row">
                    ...
                    <div class="footer-col col-md-4">
                        ...
                        <ul class="list-inline">
                            <li>
                                <a href="https://twitter.com/mikecabana" class="btn-social btn-outline" target="_blank"><i class="fa fa-fw fa-twitter"></i></a>
                            </li>
                            <li>
                                <a href="https://www.linkedin.com/in/michael-cabana-b5903a66" class="btn-social btn-outline" target="_blank"><i class="fa fa-fw fa-linkedin"></i></a>
                            </li>
                            <li>
                                <a href="https://github.com/mikecabana" class="btn-social btn-outline" target="_blank"><i class="fa fa-fw fa-github"></i></a>
                            </li>
                        </ul>
                    </div>
                    <div class="footer-col col-md-4">
                        <h3>About This Site</h3>
                        <p>This site is powered by the <a href="http://startbootstrap.com" target="_blank">Bootstrap</a> framework.</p>
                    </div>
                </div>
            </div>
        </div>
        <div class="footer-below">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        Copyright &copy; mikecabana.me - Michael Cabana 2017
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="col-lg-8 col-lg-offset-2">
                        <div class="modal-body">
                            ...
                            <ul class="list-inline item-details">
                                ...
                                <li>Date:
                                    <strong>March 24, 2017
                                    </strong>
                                </li>
                                <li>Service:
                                    <strong>Web Development / Twitter
                                    </strong>
                                </li>
                            </ul>
                ...
                <div class="row">
                    <div class="col-lg-8 col-lg-offset-2">
                        <div class="modal-body">
                            ...
                            <ul class="list-inline item-details">
                                <li>Client:
                                    <strong><a href="http://concordia.ca" target="_blank">Concordia University</a>
                                    </strong>
                                </li>
                                <li>Date:
                                    <strong>January 9, 2017
                                    </strong>
                                </li>
                                <li>Service:
                                    <strong>Software Development - C++
                                    </strong>
                                </li>
                            </ul>
                            <button type="button" class="btn btn-default" data-dismiss="modal"><i class="fa fa-times"></i> Close</button>
                ...
                <div class="row">
                    <div class="col-lg-8 col-lg-offset-2">
                        <div class="modal-body">
                            ...
                            <ul class="list-inline item-details">
                                <li>Client:
                                    <strong><a href="http://melicoiffure.com"target="_blank">MeliCoiffure</a>
                                    </strong>
                                </li>
                                <li>Date:
                                    <strong>February 2016
                                    </strong>
                                </li>
                                <li>Service:
